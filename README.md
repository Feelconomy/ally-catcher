...
- **그린** (기본) — 밝은 초록 캐비닛 · 같은 크기 인형 28마리 · 아케이드 스틱과 드롭 버튼 분리
...
그린 모드의 인형통은 **같은 크기**(68px) 인형이 다섯 줄로 쌓인 28자리이고, 집게는 더미
**꼭대기에 얹힌 인형부터** 뭅니다 (줄 번호를 바닥부터 세어, 윗줄이 아랫줄을 덮어 그려지고
집게도 윗줄을 먼저 고릅니다). 통 높이는 기기에 맞춰 달라지고, 인형은 더미의 실제 높이
