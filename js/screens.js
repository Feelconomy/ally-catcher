...
const Screens = {
  ...
  splash() {
    ...
    screenEl().innerHTML = `<div class="screen splash">
      <div class="mark"><img src="assets/logo.png?v=115" alt="" width="88" height="88"></div>
  ...
  login() {
    ...
    screenEl().innerHTML = `<div class="screen">
      ${statusbar()}
      <div class="login">
        <div class="brandmark l"><img src="assets/logo.png?v=115" alt="" width="72" height="72"></div>
        <h2>3초면 시작해요</h2>
  ...
  home() {
    ...
    screenEl().innerHTML = `<div class="screen">
      ${statusbar()}
      <div class="home-head">
        <button class="brandmark s" data-act="egg" aria-label="올리캐쳐"><img src="assets/logo-mark.png?v=115" alt="" width="30" height="30"></button>
